...
describe("Typewriter", () => {
  ...
  it("should have added styles correctly", () => {
    ...
    expect((styleNode as HTMLElement).innerHTML).toEqual(STYLES);
  });
  ...
  describe("methods", () => {
    let instance: Typewriter;
    let instanceInitialOptions: TypewriterOptions;
    ...
    describe("runEventLoop", () => {
      ...
      describe("valid delta", () => {
        ...
        it("should use correct natural delay speed", () => {
          ...
          expect(logInDevMode.mock.calls[0][0].delay).toBeGreaterThanOrEqual(
            120
          );
        ...
        describe(`${EVENT_NAMES.REMOVE_LAST_VISIBLE_NODE}`, () => {
          ...
          beforeEach(() => {
            node = {
              parentNode: { removeChild: jest.fn() } as unknown as HTMLElement,
            } as unknown as Node;
            instance.state.eventQueue = [
              {
                eventName: EVENT_NAMES.REMOVE_LAST_VISIBLE_NODE,
